      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: ':id',
            loadChildren: () =>
              import('../people-details/people-details.module').then(
        ...
        children: [
          {
            path: '',
            loadChildren: () =>
              import('../planets/planets.module').then(
                (m) => m.PlanetsPageModule
              ),
          },
          {
            path: ':id',
            loadChildren: () =>
              import('../planets-details/planets-details.module').then(
                (m) => m.PlanetsDetailsPageModule
              ),
          },
        ],
      },
